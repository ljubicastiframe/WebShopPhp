...
if (isset($_POST["signup"])) {
    ...
    if ($password !== $cpassword) {
        ...
        $sql = "INSERT INTO users (full_name, email, pasword) VALUES ('$full_name', '$email', '$password')";
        $result = mysqli_query($conn, $sql);
        if($result) {
            echo "<script>alert('User registration Successflly.');</script>";
        } else {
        ...
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form action="#" class="sign-up-form" method="post">
                    ...
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="cpassword" placeholder="Confirm Password" name="signup_cpassword" required />
                    </div>
